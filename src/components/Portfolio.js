                ...
                <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10">
                    ...
                    <div className="lg:pr-4">
                        ...
                        <p className="mt-6 text-xl leading-8 text-gray-700">
                            ...
                            Dengan mengambil masalah dari kurang baiknya desain UI/UX dari <i>learning management system </i> (LMS) kuliah ITB, padahal LMS 
                            sangat dibutuhkan selama kuliah daring, membuat saya mengerjakan proyek ini sebagai saran untuk pengembangan lanjutan 
                            LMS kuliah ITB agar lebih ramah bagi pengguna, khususnya mahasiswa. 
                        </p>
                        </div>
                    </div>
                    </div>
                    ...
                    <div className="lg:pr-4">
                        ...
                        <ul role="list" className="mt-8 space-y-8 text-gray-600">
                            ...
                            <span>
                                <strong className="font-semibold text-gray-900">Tugas Akhir S-1</strong> 
                            ...
                            <span>
                                <strong className="font-semibold text-gray-900">1 tahun (Juli 2020 - Juni 2021)</strong> 
                            ...
                            <span>
                                <strong className="font-semibold text-gray-900">Kuesioner, Wawancara, dan Literatur</strong> 
                                <br/>Metode pengumpulan data pada portofolio ini, terdiri dari data kuantitatif (kuesioner), kualitatif (wawancara), dan sekunder (literatur).
                            </span>
                            </li>
                            <li className="flex gap-x-3">
                            ...
                            <span>
                                ...
                                <br/>Kakas (<i>tools</i>) yang digunakan untuk membuat portofolio ini.
                            </span>
                            </li>
                        </ul>
                        <p className="mt-8">
