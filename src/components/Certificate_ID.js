...
export default function Certificate_ID() {
                    ...
                    <div className="mx-auto grid py-32 ax-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10">
                        ...
                        <div className="lg:pr-4">
                            <div className="lg:max-w-lg">
                                ...
                                <h1 className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Belajar dan mengajar. Ilmu untuk semua.</h1>
                                <p className="mt-6 text-xl leading-8 text-gray-800">
                                Di halaman ini, Anda akan melihat beberapa sertifikat yang saya peroleh, seperti sertifikat profesional, kelas, magang, dan pembicara.
                                </p>
